...
func (c *cartClient) CreateCart(ctx context.Context, in *CreateCartRequest, opts ...grpc.CallOption) (*CreateCartReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.cart.service.v1.Cart/CreateCart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cartClient) UpdateCart(ctx context.Context, in *UpdateCartRequest, opts ...grpc.CallOption) (*UpdateCartReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.cart.service.v1.Cart/UpdateCart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cartClient) ListCart(ctx context.Context, in *ListCartRequest, opts ...grpc.CallOption) (*ListCartReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.cart.service.v1.Cart/ListCart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Cart_CreateCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.cart.service.v1.Cart/CreateCart",
	}
...
func _Cart_UpdateCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.cart.service.v1.Cart/UpdateCart",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Cart_ListCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.cart.service.v1.Cart/ListCart",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Cart_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/cart/v1/cart/cart.proto",
}
